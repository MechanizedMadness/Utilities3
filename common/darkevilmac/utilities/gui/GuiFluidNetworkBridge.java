...
public class GuiFluidNetworkBridge extends GuiContainer {
    ...
    protected void drawGuiContainerBackgroundLayer(float var1, int var2, int var3) {
        ...
        if (tile == null) {
        } else if (tile.fluidFilters.isEmpty()) {
            System.out.println("Null Filters");
            tile.fixEmptyFilters();
        }

        // Draw Fluids in slots

        // Row 1
        drawTexturedModelRectFromIcon(27, 18, tile.fluidFilters.get(0).getIcon(), 16, 16);
        drawTexturedModelRectFromIcon(45, 18, tile.fluidFilters.get(1).getIcon(), 16, 16);
        drawTexturedModelRectFromIcon(63, 18, tile.fluidFilters.get(2).getIcon(), 16, 16);
        drawTexturedModelRectFromIcon(81, 18, tile.fluidFilters.get(3).getIcon(), 16, 16);
        drawTexturedModelRectFromIcon(99, 18, tile.fluidFilters.get(4).getIcon(), 16, 16);
        drawTexturedModelRectFromIcon(117, 18, tile.fluidFilters.get(5).getIcon(), 16, 16);
        drawTexturedModelRectFromIcon(135, 18, tile.fluidFilters.get(6).getIcon(), 16, 16);

        // Row 2
        drawTexturedModelRectFromIcon(27, 36, tile.fluidFilters.get(7).getIcon(), 16, 16);
        drawTexturedModelRectFromIcon(45, 36, tile.fluidFilters.get(8).getIcon(), 16, 16);
        drawTexturedModelRectFromIcon(63, 36, tile.fluidFilters.get(9).getIcon(), 16, 16);
        drawTexturedModelRectFromIcon(81, 36, tile.fluidFilters.get(10).getIcon(), 16, 16);
        drawTexturedModelRectFromIcon(99, 36, tile.fluidFilters.get(11).getIcon(), 16, 16);
        drawTexturedModelRectFromIcon(117, 36, tile.fluidFilters.get(12).getIcon(), 16, 16);
        drawTexturedModelRectFromIcon(135, 36, tile.fluidFilters.get(13).getIcon(), 16, 16);
    }
