...
public class ModBlocks {
    ...
    public static void init() {
        ...
        GameRegistry.registerTileEntity(TileEntityMultiNetworkBridge.class, "tile" + Strings.MULTINETWORK_BRIDGE_BLOCKNAME);
        ...
        GameRegistry.registerTileEntity(TileEntityMultiNetworkManager.class, "tile" + Strings.MULTINETWORK_MANAGER_BLOCKNAME);
        ...
        GameRegistry.registerBlock(multiNetworkBridge, Strings.MULTINETWORK_BRIDGE_BLOCKNAME);
        ...
        GameRegistry.registerBlock(multiNetworkManager, Strings.MULTINETWORK_MANAGER_BLOCKNAME);
