        ...
        if (!world.isRemote) {
            if (player != null) {
                if (player.getCurrentEquippedItem() != null && player.getCurrentEquippedItem().getItem() != null) {
                    if (player.getCurrentEquippedItem().getItem() instanceof ItemPipeLinker) {
                        if (player.getCurrentEquippedItem().hasTagCompound() && player.getCurrentEquippedItem().getTagCompound().getBoolean("hasManager")
                            ...
                            if (world.getTileEntity(managerXCoord, managerYCoord, managerZCoord) != null
                                ...
                                if (getTile(world, x, y, z) != null && getTile(world, x, y, z) instanceof TileEntityEnergyNetworkBridge) {
                                    if (!((TileEntityEnergyNetworkManager) world.getTileEntity(managerXCoord, managerYCoord, managerZCoord)).energyBridges.contains((world
                                            .getTileEntity(x, y, z)))) {
                                        ...
                                        ((TileEntityEnergyNetworkBridge) world.getTileEntity(x, y, z)).setManager((TileEntityEnergyNetworkManager) world.getTileEntity(
                                                managerXCoord, managerYCoord, managerZCoord));
                                    }
                                }
                            } else {
